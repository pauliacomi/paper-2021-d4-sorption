...
densities, \ce{N2}-accessible surface areas (SAs), pore volumes (PVs) and void
...
moves were attempted. The D4/MOF and \ce{H2O}/MOF interactions were described by
...
parameters were taken from the UFF forcefield as currently employed
...
TGA, PXRD and \ce{N2} physisorption are given in the SI. All samples were
...
The D4 adsorption uptakes for the selected MOFs were simulated using single
...
\ce{Zr6}-oxoclusters in an antiprismatic fashion, forming vertex-sharing
...
(30 Å) and are typically decorated by \ce{OH/H2O} moieties coordinated to the
remaining axial positions of the \ce{Zr6} node.
...
Finally, stability of PCN-777 after its use as a D4 adsorbent was evaluated
